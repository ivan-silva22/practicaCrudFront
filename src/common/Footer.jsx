      ...
      <Row className="bg-footer-nav text-center p-3 font shadow-lg p-3 footer">
        ...
        <Col sm={12} md={4}>
          <div className="my-2">
            ...
            <p className="text-white">Telefono: 3815443015</p>
            <p className="text-white">Direccion: Av. Ejercito del Norte 516</p>
        ...
        <Col sm={12} md={4}>
          <div className="my-3">
            ...
            <a className="ms-3 redSocial " href="#">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="35"
                height="35"
